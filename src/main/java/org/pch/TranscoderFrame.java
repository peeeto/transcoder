...
//        setExtendedState(NORMAL);
  ...
  private void initComponents() {
    ...
    jPanelMd5.setLayout(new java.awt.GridLayout());
    ...
    jPanelSha1.setLayout(new java.awt.GridLayout());
    ...
    jPanelSha256.setLayout(new java.awt.GridLayout());
    ...
    jPanelSha384.setLayout(new java.awt.GridLayout());
    ...
    jPanelSha512.setLayout(new java.awt.GridLayout());
    ...
    jPanelCRC32.setLayout(new java.awt.GridLayout());
    ...
    jPanelAdler32.setLayout(new java.awt.GridLayout());
